...
const Navbar = () => {
    ...
    return (
        <nav className='bg-[#f5f7fa] dark:bg-gray-700 flex items-center justify-between shadow-lg fixed h-[78px] w-full top-0 z-50 p-4'>
            <Link to="/" >
            ...
            <div className="hidden lg:flex gap-2 ">
                <Link to="/login"><button className="px-4 py-2 rounded-lg font-bold hover:bg-yellow-300">Sign in</button></Link>
